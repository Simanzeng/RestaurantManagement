...
public class StaffModifyPassword extends JFrame {
	...
	boolean selectStaffTable(MouseEvent e) //查询管理员表中是否有此用户
	{
		try
		{
	...
	void updateStaffTable(MouseEvent e) //更新密码
	{
		try
		{
			stat=conn.createStatement(); //创建命令语句
